<x-app-layout>
    <body class="">
                                ...
                                <div class="box-body !p-0 customers mt-1">
                                    <div class="ti-list-group ti-list-group-flush">
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('public/images/faces/3.jpg') }}" alt="Image description">
                                                <div class="flex-grow">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('public/images/faces/11.jpg') }}" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('public/images/faces/17.jpg') }}" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('public/images/faces/15.jpg') }}" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('public/images/faces/6.jpg') }}" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
		...
		<script>
			...
			const el = document.querySelector("#us-map1");
			if (!el) {
				console.error("us-map1 element not found");
				return;
			}
			var options = {
				chart: {
