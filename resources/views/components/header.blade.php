  ...
  <nav class="main-header" aria-label="Global">
    ...
    <div class="header-content-left">
      ...
      <div class="horizontal-logo">
        ...
        <img src="{{ asset('public/logo/desktop-logo.png') }}" alt="logo" class="desktop-logo" style="height:30px;width:86px;">
        <img src="{{ asset('public/logo/toggle-logo.png') }}" alt="logo" class="toggle-logo">
        <img src="{{ asset('public/logo/desktop-dark.png') }}" alt="logo" class="desktop-dark">
        <img src="{{ asset('public/logo/toggle-dark.png') }}" alt="logo" class="toggle-dark">
        <img src="{{ asset('public/logo/desktop-white.png') }}" alt="logo" class="desktop-white">
        </a>
      </div>
      </div>
    ...
    <div class="header-content-right">
      ...
      <a href="javascript:void(0);" class="header-link dropdown-toggle" id="hs-dropdown-auto-close-inside"  data-bs-toggle="dropdown" aria-expanded="false"
      ...
      <div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem] hidden !left-[-7rem] !-mt-2"
        ...
        <div class="py-2 first:pt-0 last:pb-0">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            ...
            <img src="{{ asset('public/images/flags/french_flag.jpg') }}" alt="flag-img"
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="{{ asset('public/images/flags/germany_flag.jpg') }}" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="{{ asset('public/images/flags/italy_flag.jpg') }}" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="{{ asset('public/images/flags/russia_flag.jpg') }}" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="{{ asset('public/images/flags/spain_flag.jpg') }}" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
        ...
        <div
          ...
          <li class="dropdown-item">
            ...
            <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
              <img src="{{ asset('public/images/faces/12.jpg') }}" alt="img">
            </span>
            <div>
              <div class="flex">
              <a href="">
          ...
          <li class="dropdown-item">
            <div class="flex messages">
            <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
              <img src="{{ asset('public/images/faces/3.jpg') }}" alt="img">
            </span>
            <div>
              <div class="flex">
              <a href="chat.html">
          ...
          <li class="dropdown-item">
            <div class="flex messages">
            <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
              <img src="{{ asset('public/images/faces/5.jpg') }}" alt="img">
            </span>
            <div>
              <div class="flex">
              <a href="chat.html">
          ...
          <li class="dropdown-item">
            <div class="flex messages">
            <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
              <img src="{{ asset('public/images/faces/4.jpg') }}" alt="img">
            </span>
            <div>
              <div class="flex">
              <a href="chat.html">
          ...
          <li class="dropdown-item !rounded-bl-md !rounded-br-md">
            <div class="flex messages">
            <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
              <img src="{{ asset('public/images/faces/1.jpg') }}" alt="img">
            </span>
            <div>
              <div class="flex">
              <a href="chat.html">
      ...
      <div class="header-element md:!px-[0.5rem] px-2 hs-dropdown profile-dropdown !items-center ti-dropdown [--placement:bottom-right]">
        <button id="dropdown-profile" type="button" class="hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent ">
          <img class="inline-block rounded-full " src="{{ asset('public/17.jpg') }}" width="37" height="37"
        ...
        <div class="main-header-dropdown !-mt-2 !p-0 hs-dropdown-menu ti-dropdown-menu bg-white !border-0 border-defaultborder hidden !m-0"
          ...
          <li>
            ...
            <div class="my-auto">
              <h6 class="mb-0 leading-none text-white">Devendra Raghav</h6><span
              class="text-[.6875rem] opacity-[0.7] leading-none">Super Admin</span>
            </div>
            </div>
          </li>
          <li><a class="dropdown-item text-defaulttextcolor flex " href="javascript:void(0);"><i
          ...
          <li><a class="dropdown-item text-defaulttextcolor flex  border-block-end" href="javascript:void(0);"><i
          ...
          <li>
              <form method="POST" action="{{ route('logout') }}">
                  @csrf
                  <a href="javascript:void(0);" class="dropdown-item text-defaulttextcolor !rounded-bl-md !rounded-br-md flex"
