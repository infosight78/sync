<aside class="app-sidebar" id="sidebar">
	<div class="main-sidebar-header">
		<a href="{{ route('dashboard') }}" class="header-logo">
			<img src="{{ asset('public/logo/desktop-logo.png') }}" alt="SYNC" class="desktop-logo" style="height:54px;width:86px;">
			<img src="{{ asset('public/logo/toggle-logo.png') }}" alt="SYNC" class="toggle-logo">
			<img src="{{ asset('public/logo/desktop-dark.png') }}" alt="SYNC" class="desktop-dark">
			<img src="{{ asset('public/logo/toggle-dark.png') }}" alt="SYNC" class="toggle-dark">
			<img src="{{ asset('public/logo/desktop-white.png') }}" alt="SYNC" class="desktop-white">
		</a>
	</div>
			...
			<ul class="main-menu">
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="{{ route('vendors.create') }}" class="side-menu__item">Add Vendor</a>
							<a href="{{ route('vendors.list') }}" class="side-menu__item">List Vendor</a>
						</li>
					</ul>
				</li>
				<li class="slide has-sub">
