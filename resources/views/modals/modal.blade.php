					...
					<div class="box overflow-hidden !mb-0 !border-0 !shadow-none">
						...
						<div class="float-start xs:hidden flex">
							<div class="avatar avatar-lg rounded-circle me-3"> 
								<img src="{{ asset('public/images/faces/6.jpg') }}" class="rounded-circle user_img" alt="img"> 
							</div>
						...
						<div class="flex justify-start">
							<div class="img_cont_msg"> <img src="{{ asset('public/images/faces/6.jpg') }}" class="rounded-circle user_img_msg"
								alt="img"> </div>
						...
						<div class="flex justify-end ">
							...
							<div class="img_cont_msg"> <img src="{{ asset('public/images/faces/9.jpg') }}" class="rounded-circle user_img_msg"
								alt="img"> </div>
						</div>
						<div class="flex justify-start ">
							<div class="img_cont_msg"> <img src="{{ asset('public/images/faces/6.jpg') }}" class="rounded-circle user_img_msg"
