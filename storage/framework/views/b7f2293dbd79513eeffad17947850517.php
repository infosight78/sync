<aside class="app-sidebar" id="sidebar">
	<div class="main-sidebar-header">
		<a href="<?php echo e(route('dashboard')); ?>" class="header-logo">
			<img src="<?php echo e(asset('public/logo/desktop-logo.png')); ?>" alt="SYNC" class="desktop-logo" style="height:54px;width:86px;">
			<img src="<?php echo e(asset('public/logo/toggle-logo.png')); ?>" alt="SYNC" class="toggle-logo">
			<img src="<?php echo e(asset('public/logo/desktop-dark.png')); ?>" alt="SYNC" class="desktop-dark">
			<img src="<?php echo e(asset('public/logo/toggle-dark.png')); ?>" alt="SYNC" class="toggle-dark">
			<img src="<?php echo e(asset('public/logo/desktop-white.png')); ?>" alt="SYNC" class="desktop-white">
		</a>
	</div>
	<div class="main-sidebar" id="sidebar-scroll">
		<nav class="main-menu-container nav nav-pills flex-column sub-open">
			...
			<ul class="main-menu">
				...
				<li class="slide">
					<a href="<?php echo e(route('dashboard')); ?>" class="side-menu__item">
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="<?php echo e(route('vendors.create')); ?>" class="side-menu__item">Add Vendor</a>
							<a href="<?php echo e(route('vendors.list')); ?>" class="side-menu__item">List Vendor</a>
						</li>
					</ul>
				</li>
				<li class="slide has-sub">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">Project & Orders</span>
						<i class="fe fe-chevron-right side-menu__angle"></i>
					</a>
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="" class="side-menu__item">Project & Orders</a>
						</li>
					</ul>
				</li>
				<li class="slide has-sub">
				...
				<li class="slide has-sub">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">Credit Card Program</span>
						<i class="fe fe-chevron-right side-menu__angle"></i>
					</a>
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="" class="side-menu__item">Credit Card Program</a>
						</li>
					</ul>
				</li>
				<li class="slide">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">Creative</span>
					</a>
				</li>
				<li class="slide">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">Vendor Listing</span>
					</a>
				</li>
				<li class="slide">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">US/Canada Reimbursement</span>
					</a>
				</li>
				<li class="slide">
					<a href="javascript:void(0);" class="side-menu__item">
						...
						<span class="side-menu__label">Where is The Office</span>
					</a>
				</li>
				<li class="slide has-sub">
					<a href="javascript:void(0);" class="side-menu__item">
					...
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="" class="side-menu__item">Reports here..</a>
						</li>
					</ul>
				</li>
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="" class="side-menu__item">HR</a> 
						</li>
					</ul>
				</li>
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						<li class="slide">
							<a href="" class="side-menu__item">Miscellaneous</a>
						</li>
					</ul>
				</li>
			</ul>
...
<?php /**PATH C:\xampp\htdocs\sync\resources\views/components/sidebar/sidebar.blade.php ENDPATH**/ ?>