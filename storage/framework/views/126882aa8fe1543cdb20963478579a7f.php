  ...
  <nav class="main-header" aria-label="Global">
    ...
    <div class="header-content-left">
      ...
      <div class="horizontal-logo">
        ...
        <img src="<?php echo e(asset('public/logo/desktop-logo.png')); ?>" alt="logo" class="desktop-logo" style="height:30px;width:86px;">
        <img src="<?php echo e(asset('public/logo/toggle-logo.png')); ?>" alt="logo" class="toggle-logo">
        <img src="<?php echo e(asset('public/logo/desktop-dark.png')); ?>" alt="logo" class="desktop-dark">
        <img src="<?php echo e(asset('public/logo/toggle-dark.png')); ?>" alt="logo" class="toggle-dark">
        <img src="<?php echo e(asset('public/logo/desktop-white.png')); ?>" alt="logo" class="desktop-white">
        </a>
      </div>
      </div>
    ...
    <div class="header-content-right">
      ...
      <div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem] hidden !left-[-7rem] !-mt-2"
        ...
        <div class="py-2 first:pt-0 last:pb-0">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            ...
            <img src="<?php echo e(asset('public/images/flags/french_flag.jpg')); ?>" alt="flag-img"
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="<?php echo e(asset('public/images/flags/germany_flag.jpg')); ?>" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="<?php echo e(asset('public/images/flags/italy_flag.jpg')); ?>" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="<?php echo e(asset('public/images/flags/russia_flag.jpg')); ?>" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
            <div class="flex items-center rounded-full">
            <img src="<?php echo e(asset('public/images/flags/spain_flag.jpg')); ?>" alt="flag-img"
              class="h-[1.1875rem] w-[1.1875rem] rounded-full">
            </div>
            <div>
            <p class="!text-[0.8125rem] font-medium">
      ...
      <div class="header-element md:!px-[0.5rem] px-2 hs-dropdown profile-dropdown !items-center ti-dropdown [--placement:bottom-right]">
        <button id="dropdown-profile" type="button" class="hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent ">
          <img class="inline-block rounded-full " src="<?php echo e(asset('public/17.jpg')); ?>" width="37" height="37"
...
</header><?php /**PATH C:\xampp\htdocs\sync\resources\views/components/header.blade.php ENDPATH**/ ?>