<div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right !border-0" tabindex="-1">
        ...
        <div class="ti-offcanvas-footer gap-4 sm:flex justify-between">
          <a href="https://1.envato.market/7axkzO" target="_blank" class="w-full ti-btn ti-btn-primary-full m-1">Buy Now</a>
          <a href="https://1.envato.market/MGEaN" target="_blank" class="w-full ti-btn ti-btn-info-full m-1">Our Portfolio</a>
          <a href="javascript:void(0);" id="reset-all" class="w-full ti-btn ti-btn-danger-full m-1">Reset</a>
        </div>
      </div><?php /**PATH C:\xampp\htdocs\sync\resources\views/components/theme-switcher.blade.php ENDPATH**/ ?>